...
- Apple OS X / Apple clang 13.0.0 / gfortran 11.2.0 / cmake 3.31.12 / SLICOT 5.9.1 / OpenBLAS 0.3.34
```
mkdir build
cd build
...
- Microsoft Windows / MSVC 19.44.35214.0 / ifx 2025.0.0 / cmake 3.31.6-msvc6 / SLICOT 5.9.1 / Intel MKL 2025.0
```
mkdir build
cd build
...
- Linux Ubuntu 24.04 / g++ 13.3.0 / gfortran 13.3.0 / cmake 3.28.3 / SLICOT 5.9.1 / libblas3 3.12.0-3build1.1
```
mkdir build
cd build
cmake -DSLICOT_DIR=<PATH_TO_SLICOT>/build/install/lib/cmake/SLICOT -DCMAKE_BUILD_TYPE=Release ..
